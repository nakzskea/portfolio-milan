...
export const dico = {
  fr: {
    ...
    technologies: [
      { nom: "TypeScript", ton: "encre" },
      { nom: "React", ton: "encre" },
      { nom: "Next.js", ton: "encre" },
      { nom: "Tailwind", ton: "encre" },
      { nom: "Prisma", ton: "encre" },
      { nom: "Python", ton: "or" },
      { nom: "SQL / MariaDB", ton: "or" },
      { nom: "Qdrant", ton: "or" },
      { nom: "Microsoft Fabric", ton: "or" },
      { nom: "Linux", ton: "bleu" },
      { nom: "Proxmox / LXC", ton: "bleu" },
      { nom: "GitHub Actions", ton: "bleu" },
      { nom: "Arduino", ton: "or" },
      { nom: "C++", ton: "or" },
      { nom: "HTML", ton: "or" },
      { nom: "CSS", ton: "or" },
    ...
    projets: [
      ...
      },
      {
        ...
        role: ["À COMPLÉTER : conception et intégration", "À COMPLÉTER : mise en ligne"],
  ...
  en: {
    ...
    projets: [
      ...
      },
      {
        ...
        role: ["TO FILL IN: design and build", "TO FILL IN: going live"],
        stack: ["HTML", "CSS", "JavaScript", "PHP"],
        lien: "https://example.com",
      },
      {
